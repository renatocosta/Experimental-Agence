...
class EloquentConsultantByPerformanceRepository implements ConsultantByPerformanceRepository {
    ...
    private function getQueryInvoice($criteria = []) {
        ...
        $query = DB::table("cao_usuario AS u")
                ->select('u.co_usuario',
                        ...
                        'fat.valor',
                        'fat.total_imp_inc',
                        'sal.brut_salario AS fixed_cost_consultant',
